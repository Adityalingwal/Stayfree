...
exports.currentState = exports.updateTrayState = void 0;
...
function createTrayIcon(state) {
    ...
    return electron_1.nativeImage.createFromDataURL(dataUrl);
}
function updateTrayState(state) {
    exports.currentState = currentState = state;
    if (tray) {
        tray.setImage(createTrayIcon(state));
        tray.setToolTip(state === 'idle' ? 'StayFree - Ready (Hold Fn to dictate)'
...
function buildContextMenu() {
    return electron_1.Menu.buildFromTemplate([
        {
            label: `StayFree v${electron_1.app.getVersion()}`,
            enabled: false,
        },
        { type: 'separator' },
        {
...
function openSettingsWindow() {
    ...
    settingsWindow = new electron_1.BrowserWindow({
        ...
        show: false,
        webPreferences: {
            preload: '/Users/mac/Desktop/StayFree/.webpack/renderer/main_window/preload.js',
        },
    });
    settingsWindow.loadURL('http://localhost:3000/main_window/index.html');
